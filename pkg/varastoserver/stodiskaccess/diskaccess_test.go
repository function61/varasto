...
func (t *testDbAccess) QueryBlobMetadata(ref varastotypes.BlobRef) (*BlobMeta, error) {
...
func TestWriteToUnknownVolume(t *testing.T) {
	s := setupDefault()
	ref, _ := varastotypes.BlobRefFromHex(sha256OfQuickBrownFox)
...
func (t *testingBlobStorage) RawFetch(ref varastotypes.BlobRef) (io.ReadCloser, error) {
...
func (t *testingBlobStorage) RawStore(ref varastotypes.BlobRef, content io.Reader) error {
